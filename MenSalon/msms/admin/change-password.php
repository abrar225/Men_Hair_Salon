...
if(isset($_POST['submit']))
{
    ...
    // Check current password using prepared statements
    ...
    if($row = mysqli_fetch_array($result)){
        if(password_verify($cpassword, $row['Password'])) {
            ...
            $update_stmt = mysqli_prepare($con, "UPDATE tbladmin SET Password = ? WHERE ID = ?");
            mysqli_stmt_bind_param($update_stmt, "si", $newpassword, $adminid);
